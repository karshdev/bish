...
function PostCode() {
  ...
  // const [address, setAdress] = useState("Moginand")
  ...
  //   try {
  //     const response = await fetch(`https://ws.postcoder.com/pcw/${apikey}/pafaddressbase/${encodeURIComponent(postcode)}`, {
  //       method: 'GET',
  ...
  //     console.log(data);
  //     // Log the fetched address (dummy content)
  //     console.log("Fetched Address:", data || "Address not found");
  //   } catch (error) {
  //     console.error(error);
