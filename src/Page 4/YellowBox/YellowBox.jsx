function YellowBox() {
  return (
    <div className="flex justify-center items-center mt-[20px] p-3">
      <div className="w-[70%] sm:w-1/3 flex flex-col justify-start items-center gap-10 sm:gap-2 p-3  bg-[#EEF973]" style={{ filter: "drop-shadow(1px 2px 3px black)" }}>
        <div className="h-[87px]">
          <p className="font-bold text-[40px] font-raleway">1</p>
        </div>
        <div className="flex flex-col gap-6">
          <p className="w-[85%] m-auto font-raleway text-center text-[16px] sm:text-[38px] font-semibold mt-[-30px]">
